...
const cartOveerlay = document.querySelector('.cart-overlay')
...
const cartModalOpen = ()=>{
    cartOveerlay.classList.add('cart-overlay-open')
    disableScroll()
    renderCard()
}
const cartModalClose = ()=>{
    cartOveerlay.classList.remove('cart-overlay-open')
    enableScroll()
}
...
cartOveerlay.addEventListener('click', event => {
...
const renderCartGood = ([{id, brand, name, cost, color, sizes, photo}])=>{
    ...
    cardGoodBuy.addEventListener('click', ()=>{
        if(cardGoodBuy.classList.contains('delete')){
            ...
            cardGoodBuy.textContent = 'Добавить в корзины'
            return
        }
